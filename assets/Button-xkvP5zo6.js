import{l as o,$ as s,a0 as l,d as b,j as n,K as m}from"./index-C2G7T-C2.js";const e=o`
  ${l}
...
`,u={primary:e,secondary:y,auth:h},g=b.button`
  ${({$kind:r})=>u[r||"primary"]}

  position: relative;
`,$=({children:r,kind:a="primary",isLoading:t,isDisabled:c=t,type:d="button",onClick:i})=>n.jsx(g,{disabled:c,type:d,$kind:a,onClick:i,children:t?n.jsx(m,{}):r});export{$ as B,y as a};

import{o as m,J as f,m as $,A as j,K as r,P as y,v as s,l as i,d as o,a as L,q as v,j as t,I as b}from"./index-C_i5Jflz.js";import{u as T}from"./useMutation-D0smmmYM.js";import{B as w}from"./Button-Cy4Imw9M.js";function z(){const e=m(),a=f(),n=$(),l=T({mutationFn:()=>j.logoutUser(),onSuccess:()=>{e(r()),n.removeQueries({queryKey:["me"]}),a("/",{replace:!0})},onError:()=>{e(r()),n.removeQueries({queryKey:["me"]}),a("/",{replace:!0})}}),d=()=>{l.mutate()},g=l.isPending;return{handleLogout:d,isPending:g}}const I=o.div`
  display: flex;

import{o as m,J as f,m as j,A as $,K as r,v as s,l as i,d as o,a as y,q as L,j as t,I as v}from"./index-DRmv6lOD.js";import{u as b}from"./useMutation-Ch62a-TB.js";import{B as T}from"./Button-C2DmmOPo.js";function w(){const e=m(),a=f(),n=j(),l=b({mutationFn:()=>$.logoutUser(),onSuccess:()=>{e(r()),n.removeQueries({queryKey:["me"]}),a("/",{replace:!0})},onError:()=>{e(r()),n.removeQueries({queryKey:["me"]}),a("/",{replace:!0})}}),d=()=>{l.mutate()},g=l.isPending;return{handleLogout:d,isPending:g}}const z=o.div`
  display: flex;
